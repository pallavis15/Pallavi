...
public class CountryRunner {
	...
	public static void main(String[] args) {
		...
		CountryDTO country = new CountryDTO(196, "kailasa", "kaila", 200000, "oct15, 2019", 3, "Hindu", "lion",
				"Andean Cock-of-the-rock", "basketball", "Pallavi");
		...
		CountryDTO ref1 = new CountryDTO(196, "kailasa", "kaila", 200000, "oct15, 2019", 3, "Hindu", "lion",
				"Andean Cock-of-the-rock", "basketball", "Pallavi");
		boolean cont2 = countries.contains(ref1);
		System.out.println("cont2:" + cont2);

		Iterator<CountryDTO> itr1 = countries.iterator();
		while (itr1.hasNext()) {
			CountryDTO ref = itr1.next();
			if (ref.getName().startsWith("I"))
		...
		while (itr2.hasNext()) {
			CountryDTO ref2 = itr2.next();
			if (ref2.getName().contains("an"))
		...
		while (itr3.hasNext()) {
			CountryDTO ref3 = itr2.next();
			if (ref3.getName().contains("ma"))
				System.out.println(ref3.getName());
			countContainsMa++;
		}
		System.out.println("countContainsMa:" + countContainsMa);

		for (CountryDTO ref4:countries) {

			if (ref4.getName().endsWith("A")) {
